...
$font = '../polices/Minecraftia-Regular.ttf';
...
foreach ($gains as $jour) {
	...
	imagettftext($image, 6, 0, ($i - 20), ($hauteur_image), $noir, $font, $date);
	imagettftext($image, 6, 0, ($i - 10), ($y1), $noir, $font, number_format($somme, 2));
